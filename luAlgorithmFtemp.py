from luFunctions import clock_msg,orientPCA,sortSliceX,assignXslice,removeDeckTop
...
write = False
notDeckX,deckX = assignXslice(xSlice, p1, zMax, zMin, write)
#step2.5
...
for i in range(len(deckX)):
    deck = np.vstack((deck,deckX[i]))
    #big_deck.append(deckX[i])
